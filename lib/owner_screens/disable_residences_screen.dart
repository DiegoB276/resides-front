...
class DisableResidencesScreen extends StatelessWidget {
  const DisableResidencesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xff4E2A2A),
        surfaceTintColor: Color(0xff4E2A2A),
        title: const Text(
